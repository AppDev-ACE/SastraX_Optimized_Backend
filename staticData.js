...
export const messMenuData = {
    boys: [
        //Week 2
      {
        week : "2",
        day : "Monday",
        breakfast : ["Ragi Dosa","Sambar","Tomato Chutney","Multi Grain Koozhu","Curd Chilly"],
        ...
        dinner: ["Chappathi","Salna","Rava Upma","Sambar","Cocunut Chutney","White Rice","Buttermilk","Pickle","Banana (1 No)"] 
      },
      {
        week : "2",
        day : "Tuesday",
        breakfast : ["Idly","Carrot Beans Sambar","Peanut Chutney","Podi with Oil","BBJ"],
        lunch : ["Chappathi","Channa Masala","White Rice","Raddish Sambar","Cabbage Peas Poriyal","Masala Vada","Dhall Rasam","Curd","Fryums","Pickle"],
        snacks: ["Tea, Milk and Coffee","Raw Banana Bajji / Spinach Vada"],
        dinner: ["Adai / Dosa","Sambar","Cocunut Chutney","Tamarind Rice","Thuvaiyal","Fryums","Curd Rice","Pickle","Banana (1 No)"] 
      },
      {
        week : "2",
        day : "Wednesday",
        breakfast : ["Tamarind Sevai","Sambar","Cocunut Chutney","Ragi Koozhu","Curd Chilly","Masala Vada"],
        lunch : ["Chappathi","Palak Paneer","White Rice","Ladies Finger Morekuzhambu","Potato Peas Palkoottu","Tindly Kara Curry","Malli Rasam","Curd","Appalam","Pickle","Paruppu Podi with Oil"],
      ...
      },
      {
        week : "2",
        day : "Thursday",
        breakfast : ["Mix Veg Uthappam","Small Onion Sambar","Coconut Chutney","BBJ"],
        lunch : ["Chappathi","Rajma Masala","White Rice","Mix Veg Sambar","Yam Channa Poriyal","Podalanga Kootu","Mysore Rasam","Curd","Fryums","Pickle"],
        snacks: ["Tea, Milk and Coffee","Black Channa Sundal"],
        dinner: ["Chappathi","Veg Kuruma","White Rice","Appalam","Buttermilk","Lemon Juice","Pickle","Banana (1 No)"] 
      },
      {
        week : "2",
        day : "Friday",
        breakfast : ["Upma","Sambar","Kara Chutney","Masala Vada","Cornflakes with Hot Milk"],
        lunch : ["Chappathi","Channa Masala","White Rice","Spinach Kuzhambu","Beans Usili","Aviyal","Lemon Rasam","Curd","Fryums","Pickle","Jangiri"],
        snacks: ["Tea, Milk and Coffee","Veg Puff"],
        dinner: ["Chappathi","Vadacurry","White Rice","Appalam","Buttermilk","Pickle","Banana (1 No)"] 
      },
      {
        week : "2",
        day : "Saturday",
        breakfast : ["Pongal","Kosthu","Coconut Chutney","BBJ","Medhu Vada"],
        lunch : ["Chappathi","Kadalacurry","White Rice","Coconut Rice","Aloo 65","Chow Chow Koottu","Garlic Rasam","Curd","Fryums","Pickle",,"Paruppu Podi with Oil"],
      ...
      },
      {
        week : "2",
        day : "Sunday",
        breakfast : ["Poori","Aloo/Channa Masala","Coconut Chutney"],
        lunch : ["Veg Corn Fried Rice","Mix Veg Manchurian","Veg Soup","White Rice","Dhall & Ghee","Aloo Kara Curry","Tomato Rasam","Buttermilk","Appalam","Pickle","Vermicelli Payasam/Fruit Salad"],
        snacks: ["Tea, Milk and Coffee","Samosa / Jam Bun"],
        dinner: ["Onion Utthappam","Sambar","Tomato Chutney","White Rice","Rasam","Buttermilk","Gongura","Banana (1 No)"] 
      },
      ...
      //Week 1
      {
        week : "1",
        day : "Monday",
        breakfast : ["Dosa","Vadacurry","Coconut Chutney","Oats"],
        lunch : ["Chappathi","Dhall","White Rice","Vathakuzhambu","Beetroot Channa Poriyal","Spinach Kootu","Tomato Rasam","Curd","Appalam","Pickle","Paruppu Podi with Oil"],
        snacks: ["Tea, Milk and Coffee","White Channa Sundal"],
        dinner: ["Butter Chappathi","Kadai Veg Curry","Dhall Kichadi","White Rice","Buttermilk","Appalam","Pickle","Banana (1 No)"] 
      },
      {
        week : "1",
        day : "Tuesday",
        breakfast : ["Idly","Sambar","Peanut Chutney","Masala Vada"],
        lunch : ["Chappathi","Channa Masala","White Rice","Raddish Sambar","Carrot Poriyal","Podalanga Kootu","Rasam","Curd","Fryums","Pickle"],
        snacks: ["Tea, Milk and Coffee","Thenkuzhal Murukku"],
        dinner: ["Chappathi","Mix Veg Gravy","Tomato Rice","Onion Raitha","White Rice","Buttermilk","Pickle","Banana (1 No)"] 
      },
      {
        week : "1",
        day : "Wednesday",
        breakfast : ["Tomato Sevai","Sambar","Coconut Chutney","Kambu Koozhu","Curd Chilly"],
        lunch : ["Chappathi","Aloo Capsicum Masala","White Rice","Pumpkin Morekuzhambu","Cabbage Peas Poriyal","Tindly Kara Curry","Rasam","Curd","Fryums","Pickle","Paruppu Podi with Oil"],
        snacks: ["Tea, Milk and Coffee","Coconut Mango Peas Sundal"],
        dinner: ["Chappathi","Black Channa Masala","Coconut Rice","Potato Chips","White Rice","Buttermilk","Pickle","Banana (1 No)"] 
      },
      {
        week : "1",
        day : "Thursday",
        breakfast : ["Rava Kichadi","Sambar","Coconut Chutney","BBJ"],
        lunch : ["Chappathi","Paneer Butter Masala","White Rice","Sambar","Aloo 65","Onion Bonda","Rasam","Curd","Fryums","Pickle"],
        snacks: ["Tea, Milk and Coffee","Mixture"],
        dinner: ["Idli","Kara Chutney","Sambar","Podi with Oil","Lemon Rice","Curd Rice","Fryums","Pickle","Banana (1 No)"] 
      },
      {
        week : "1",
        day : "Friday",
        breakfast : ["Pongal","Sambar","Coconut Chutney","Medhu Vada(1)","BBJ"],
        lunch : ["Chappathi","White Kuruma","White Rice","Karakuzhambu","Raw Banana Poriyal","Potato Peas Paalkootu","Rasam","Curd","Appalam","Pickle","Milk Peda"],
        snacks: ["Tea, Milk and Coffee","Cutlet"],
        dinner: ["Set Dosa","Vadacurry","Coconut Chutney","Malli Rice","Thuvaiyal","Lemon Juice","Curd Rice","Pickle","Banana (1 No)"] 
      },
      {
        week : "1",
        day : "Saturday",
        breakfast : ["Idli","Sambar","Tomato Chutney","Podi with Oil"],
        lunch : ["Chappathi","Green Peas Masala","White Rice","Sambar","Beans Usili","Aviyal","Rasam","Curd","Appalam","Pickle","Paruppu Podi with Oil"],
        snacks: ["Tea, Milk and Coffee","Moong Dal Sundal"],
        dinner: ["Veg Noodles","Tomato Sauce","Brinji Rice","Onion Raitha","Curd Rice","Pickle","Fryums","Banana (1 No)"] 
      },
      {
        week : "1",
        day : "Sunday",
        breakfast : ["Vermicelli Upma","Sambar","Coconut Chutney","Medhu Vada(1)","BBJ"],
        lunch : ["Aloo Paratha","Hyderabad Veg Biriyani","Onion Raitha","White Rice","Dhall & Ghee","Potato Poriyal","Rasam","Buttermilk","Appalam","Pickle","Icecream"],
        snacks: ["Tea, Milk and Coffee","Bhel Puri"],
        dinner: ["Onion Utthappam","Sambar","Kara Chutney","Rasam","White Rice","Buttermilk","Pickle","Banana (1 No)"] 
      },
